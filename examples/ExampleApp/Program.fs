...
let demoExternalKind () =
    ...
    // External vars are runtime-only: read from the environment but never persisted.
    // Use ConfigVarKind.isPersistable to filter them out before writing to SSM or .env.
